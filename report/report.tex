...
The input CSV was understood to have the structure shown in figure \ref{fig:structure} repeated once for each component (64 times) on each row.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=\linewidth]{images/structure}
	\caption{The repeated structure of the input CSV files.}
	\label{fig:structure}
\end{figure}
